...
class PlageTravailController extends Controller
{
    ...
    public function newAction(Request $request)
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            $em->flush($plageTravail);

            return $this->redirectToRoute('plagetravail_show', array('id' => $plageTravail->getId()));
        }
     ...
     *
     * @Route("/{id}", name="plagetravail_show")
     * @Method("GET")
     */
     ...
     *
     * @Route("/{id}/edit", name="plagetravail_edit")
     * @Method({"GET", "POST"})
     */
    public function editAction(Request $request, PlageTravail $plageTravail)
    {
        ...
        if ($editForm->isSubmitted() && $editForm->isValid()) {
            ...
            return $this->redirectToRoute('plagetravail_edit', array('id' => $plageTravail->getId()));
        }
     ...
     *
     * @Route("/{id}", name="plagetravail_delete")
     * @Method("DELETE")
     */
    ...
    private function createDeleteForm(PlageTravail $plageTravail)
    {
        return $this->createFormBuilder()
            ->setAction($this->generateUrl('plagetravail_delete', array('id' => $plageTravail->getId())))
            ->setMethod('DELETE')
            ->getForm()
        ;
    }
