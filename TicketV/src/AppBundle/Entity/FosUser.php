...
class FosUser
{
     ...
     *
     * @ORM\ManyToMany(targetEntity="AppBundle\Entity\Projet", mappedBy="idUtilisateur")
     */
    private $idProjet;
     ...
     * @return FosUser
     */
    public function addIdProjet(\AppBundle\Entity\Projet $idProjet)
    {
     ...
     * @param \AppBundle\Entity\Projet $idProjet
     */
    public function removeIdProjet(\AppBundle\Entity\Projet $idProjet)
    {
